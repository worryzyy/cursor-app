                  ...
                  <div key={platform} className="border-t border-gray-100 pt-3">
                    ...
                    <div className="mb-3 space-y-2">
                      <div className="flex items-start">
                        <span className="mr-2 text-sm font-medium text-gray-700">Checksum:</span>
...
export async function generateMetadata({ params }: { params: { version: string } }): Promise<Metadata> {
  ...
  if (!version) {
    return {
      ...
      description: 'Please check other available Cursor versions',
    }
  }

  return {
    title: `Cursor ${version.version}${version.isLatest ? ' (Latest version)' : ''}`,
    description: `Download Cursor ${version.version} - Intelligent programming tool that supports Windows, macOS and Linux platforms`,
    keywords: ['Cursor', version.version, 'Cursor historical version download'],
    alternates: {
      canonical: `https://cursorhistory.com/versions/${version.version}`,
    },
  }
}
    ...
    <main className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="bg-white p-6 rounded-lg shadow-md mb-6">
          ...
          <p>
            This page provides detailed information about Cursor version {version}. You can find download links for various operating systems and architectures below.
            Each download includes the appropriate installer package for your system.
          </p>
        </div>
      </div>
