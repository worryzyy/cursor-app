    ...
    <section className="rounded-lg bg-gradient-to-r from-indigo-900 to-purple-900 px-6 py-12 text-white shadow-lg sm:px-12 sm:py-16">
      <div className="mx-auto max-w-6xl text-center">
        ...
        <p className="mb-8 text-lg text-blue-100 sm:text-xl">
          Cursor is an AI-driven code editor that helps developers write code faster and smarter.
          Here, you can find and download various historical versions of Cursor.
        </p>
        {latestVersion && (
          <div className="mb-6 text-center">
            <p className="mb-2 text-xl font-semibold">Latest version：Cursor {latestVersion.version}</p>
