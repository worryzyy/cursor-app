    ...
    <section className="rounded-lg bg-gradient-to-r from-indigo-900 to-purple-900 px-6 py-12 text-white shadow-lg sm:px-12 sm:py-16">
      <div className="mx-auto max-w-6xl text-center">
        <h1 className="mb-4 text-4xl font-bold tracking-tight sm:text-5xl">
          Cursor Historische Versionen Download
        </h1>
        <p className="mb-8 text-lg text-blue-100 sm:text-xl">
          Cursor ist ein von KI angetriebener Code-Editor, der Entwicklern hilft, schneller und intelligenter zu programmieren.
          Hier können Sie verschiedene historische Versionen von Cursor finden und herunterladen.
        </p>
        {latestVersion && (
          <div className="mb-6 text-center">
            <p className="mb-2 text-xl font-semibold">Neueste Version: Cursor {latestVersion.version}</p>
